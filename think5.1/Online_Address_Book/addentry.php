...
VALUES ( '" . $master_id . "',now(),now(), '" . $safe_note . "')";
        ...
        //修改私人笔记
        $change_note_sql = "UPDATE personal_notes set note ='" . $safe_city . "', date_modified =now() WHERE master_id='" . $safe_city . "'";
        $change_note_res = mysqli_query($mysqli, $change_note_sql) or die(mysqli_error($mysqli));
        $display_block = "<p>Your Personal note has been change .Would you like to <a href='$_SERVER[PHP_SELF]'>retry</a>?</p>";
    }
