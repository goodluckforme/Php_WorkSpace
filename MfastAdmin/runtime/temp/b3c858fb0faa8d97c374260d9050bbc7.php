<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:99:"D:\Apache24\htdocs\Php_WorkSpace\MfastAdmin\public/../application/common\view\tpl\dispatch_jump.tpl";i:1526123064;}*/ ?>
<!DOCTYPE html>
<html>
    <head>
    ...
    <body>
        ...
        <div class="system-message <?php echo $codeText; ?>">
            <div class="image">
                <img src="/Php_WorkSpace/MfastAdmin/public/assets/img/<?php echo $codeText; ?>.svg" alt="" width="150" />
            </div>
            <h1><?php echo $msg; ?></h1>
            <p class="jump">
